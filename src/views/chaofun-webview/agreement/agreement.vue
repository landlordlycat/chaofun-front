<template>
  <div class="container">
    <div class="content">
      ...
      <p>
        炒饭重视用户的隐私。您在使用我们的服务时，我们可能会收集和使用您的相关信息。我们希望通过本《隐私政策》向您说明，在使用我们的服务 炒饭 时 ，我们如何收集、使用、储存和分享这些信息，以及我们为您提供的访问、更新、控制和保护这些信息的方式。本《隐私政策》与您所使用的炒饭服务息息相关，希望您仔细阅读，在需要时，按照本《隐私政策》的指引，作出您认为适当的选择。本《隐私政策》中涉及的相关技术词汇，我们尽量以简明扼要的表述，并提供进一步说明的链接，以便您的理解。
      </p>
      <p>
      ...
      <p>
        您在使用我们的服务时，向我们提供的相关个人信息，例如电子邮件等；
      </p>
      <p>
      ...
      <blockquote>
        设备或软件信息（ANDROID ID），例如您的移动设备、网页浏览器或用于接入我们服务的其他程序所提供的配置信息、您的IP地址和移动设备所用的版本和设备识别码；
      </blockquote>
      <blockquote>
...
<!--      </blockquote>-->
      ...
      <h4 style="white-space: normal;">
        <span style="color: rgb(23, 26, 29); font-family:  Microsoft YaHei ,  Segoe UI , system-ui, Roboto,  Droid Sans ,  Helvetica Neue , sans-serif, Tahoma,  Segoe UI SymbolMyanmar Text , 微软雅黑; white-space: pre-wrap; background-color: rgb(255, 255, 255); font-size: 16px;">炒饭APP权限调用说明</span><span style="color: rgb(23, 26, 29); font-family:  Microsoft YaHei ,  Segoe UI , system-ui, Roboto,  Droid Sans ,  Helvetica Neue , sans-serif, Tahoma,  Segoe UI SymbolMyanmar Text , 微软雅黑; font-size: 14px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">：</span>
      </h4>
      <p>
            <span style="font-size: 16px;">
              <span style="color: rgb(23, 26, 29); font-family:  Microsoft YaHei ,  Segoe UI , system-ui, Roboto,  Droid Sans ,  Helvetica Neue , sans-serif, Tahoma,  Segoe UI SymbolMyanmar Text , 微软雅黑; white-space: pre-wrap; background-color: rgb(255, 255, 255);">1. 读写外部存储权限：当您使用炒饭APP中头像设置、评论或分享、将文件下载至本地或打开使用本地文件时，您可以通过开启存储权限使用或保存图片、视频或文件。若您不开启此权限，您将无法使用与存储卡读取或缓存相关的功能，但不影响您使用其他服务。</span><br/><br/>
              <span style="color: rgb(23, 26, 29); font-family:  Microsoft YaHei ,  Segoe UI , system-ui, Roboto,  Droid Sans ,  Helvetica Neue , sans-serif, Tahoma,  Segoe UI SymbolMyanmar Text , 微软雅黑; white-space: pre-wrap; background-color: rgb(255, 255, 255);">2. 相册权限：当您使用炒饭App中的头像设置、评论或分享、将文件下载至本地或打开使用本地文件时，您可以通过开通相册权限以便上传设备中的图片或视频。若您不开启此权限，您将无法使用图片或视频上传相关的功能，但不影响您使用其他服务。</span><br/><br/>
              <span style="color: rgb(23, 26, 29); font-family:  Microsoft YaHei ,  Segoe UI , system-ui, Roboto,  Droid Sans ,  Helvetica Neue , sans-serif, Tahoma,  Segoe UI SymbolMyanmar Text , 微软雅黑; white-space: pre-wrap; background-color: rgb(255, 255, 255);">3. 相机权限：当您使用炒饭App中的头像设置、评论或分享、将文件下载至本地或打开使用本地文件时，您可以通过开通相机权限以便进行实时拍摄并上传图片或视频进行晒图或分享、设置头像。若您不开启此权限，您将无法使用图片或视频拍摄相关的功能，但不影响您使用其他服务。</span><br/><br/>
              <span style="color: rgb(23, 26, 29); font-family:  Microsoft YaHei ,  Segoe UI , system-ui, Roboto,  Droid Sans ,  Helvetica Neue , sans-serif, Tahoma,  Segoe UI SymbolMyanmar Text , 微软雅黑; white-space: pre-wrap; background-color: rgb(255, 255, 255);">4. 位置权限：当您使用炒饭App中的特定区域产品或服务时，您可以通过开启位置权限以便查看或获取当前所在区域的产品或服务。若您不开启此权限，您将无法收到基于当前所在位置进行的推荐，但不影响您使用其他服务。</span><br/><br/>
              <span style="color: rgb(23, 26, 29); font-family:  Microsoft YaHei ,  Segoe UI , system-ui, Roboto,  Droid Sans ,  Helvetica Neue , sans-serif, Tahoma,  Segoe UI SymbolMyanmar Text , 微软雅黑; white-space: pre-wrap; background-color: rgb(255, 255, 255);">5. 麦克风权限：当您使用炒饭App中的评论或分享时，您可以开启麦克风权限拍摄视频分享到炒饭，若您不开启此权限，您将无法使用视频拍摄相关的功能，但不影响您使用其他服务。</span></span><br/>
      </p>

      <h4 style="white-space: normal;">
        <span style="color: rgb(23, 26, 29); font-family:  Microsoft YaHei ,  Segoe UI , system-ui, Roboto,  Droid Sans ,  Helvetica Neue , sans-serif, Tahoma,  Segoe UI SymbolMyanmar Text , 微软雅黑; white-space: pre-wrap; background-color: rgb(255, 255, 255); font-size: 16px;">SDK 依赖以及权限收集说明</span><span style="color: rgb(23, 26, 29); font-family:  Microsoft YaHei ,  Segoe UI , system-ui, Roboto,  Droid Sans ,  Helvetica Neue , sans-serif, Tahoma,  Segoe UI SymbolMyanmar Text , 微软雅黑; font-size: 14px; white-space: pre-wrap; background-color: rgb(255, 255, 255);">：</span>
      </h4>
      <p>
            <span style="font-size: 16px;">
              <span style="color: rgb(23, 26, 29); font-family:  Microsoft YaHei ,  Segoe UI , system-ui, Roboto,  Droid Sans ,  Helvetica Neue , sans-serif, Tahoma,  Segoe UI SymbolMyanmar Text , 微软雅黑; white-space: pre-wrap; background-color: rgb(255, 255, 255);">1. com.umeng(友盟)，会收集你的设备ID，使用情况和崩溃信息，为了给您更好的体验。</span><br/><br/>
              <span style="color: rgb(23, 26, 29); font-family:  Microsoft YaHei ,  Segoe UI , system-ui, Roboto,  Droid Sans ,  Helvetica Neue , sans-serif, Tahoma,  Segoe UI SymbolMyanmar Text , 微软雅黑; white-space: pre-wrap; background-color: rgb(255, 255, 255);">2. com.huawei.hms、com.huawei.agconnect(华为推送)，会收集你的设备信息，以便给你做消息推送。</span><br/><br/>
              <span style="color: rgb(23, 26, 29); font-family:  Microsoft YaHei ,  Segoe UI , system-ui, Roboto,  Droid Sans ,  Helvetica Neue , sans-serif, Tahoma,  Segoe UI SymbolMyanmar Text , 微软雅黑; white-space: pre-wrap; background-color: rgb(255, 255, 255);">3. com.aliyun.push(阿里云推送), 会收集你的设备信息，以便为你推送消息。</span><br/><br/></span>
      </p>
      <h4>
        <span style="color: rgb(23, 26, 29); font-family:  Microsoft YaHei ,  Segoe UI , system-ui, Roboto,  Droid Sans ,  Helvetica Neue , sans-serif, Tahoma,  Segoe UI SymbolMyanmar Text , 微软雅黑; font-size: 14px; white-space: pre-wrap; background-color: rgb(255, 255, 255);"></span>
      </h4>
      <h4 style="white-space: normal;">
        注销账户：
      </h4>
      <p style="white-space: normal;">
        可通过App私聊【cijianzy】与我们取得联系，我们一般会在15天内对您的反馈作出答复。我们承诺不会对您账号注销请求设置不合理的障碍或条件。请注意，一旦您注销炒饭账号，可能会无法使用炒饭的部分产品和服务，同时您先前积累的数据可能会不可逆地被永久删除，因此请您谨慎操作<span style="background-color: rgb(255, 255, 255); color: rgb(23, 26, 29); font-family:  Microsoft YaHei ,  Segoe UI , system-ui, Roboto,  Droid Sans ,  Helvetica Neue , sans-serif, Tahoma,  Segoe UI SymbolMyanmar Text , 微软雅黑; font-size: 14px; white-space: pre-wrap;">。</span>
      </p>
      <p>
        <span style="color: rgb(23, 26, 29); font-family:  Microsoft YaHei ,  Segoe UI , system-ui, Roboto,  Droid Sans ,  Helvetica Neue , sans-serif, Tahoma,  Segoe UI SymbolMyanmar Text , 微软雅黑; font-size: 14px; white-space: pre-wrap; background-color: rgb(255, 255, 255);"><br/></span>
      </p>
      <p>
