<template>
  <div class="container" :style="{'background-image':'linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.6)),url('+imgOrigin+ this.backgroundImage +')','background-size':'cover','background-position': 'center'}">
    ...
    <div class="game">
      <div class="info" @click="toFirstTournament">玩家图寻第一届团体赛即将开赛！</div>
...
export default {
  ...
  methods:{
    ...
    toFirstTournament() {
      try {
        window.flutter_inappwebview.callHandler('toAppPost', {postId: '1230257'});
      } catch (e) {
        tuxunOpen('https://chao.fan/p/1230257');
      }
    }
  }
}
